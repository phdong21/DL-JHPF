...
for l in range(total_num):
    ...
    error_bits=np.sum(np.abs(detected_bit_test2-trans_bit_test_label))
    total_error_bits=total_error_bits+error_bits

print(total_error_bits/(data_num_test*2*Ns*total_num))
